  ...
  */
  class Objects extends BaseObjects {
    ...
    static function findObject($object_id){
    	...
    	$concrete_object = $handler_class::instance()->findById($object_id);
    ...
    /**
 	 ...
 	 * @author Pepe
 	 */
	static function getObjects($context = null, $start = null, $limit = null, $order = null, $order_dir = null, $trashed = false, $archived = false, $filters = null, $obj_type_types=null){
